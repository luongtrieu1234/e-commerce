...
import { CuttingMchine } from "../../../constant/Data";
import Image from "../../../assets/images/test.jpg";

type cuttingMchineProp = {
  cuttingMchine: CuttingMchine;
};

function CuttingMchineCard({ cuttingMchine }: cuttingMchineProp) {
  return (
    <li
...
export default CuttingMchineCard;
